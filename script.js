$(document).ready(function() {
    ...
    const movies = [
        // Your movie data array is kept here, with 'heroBg' which holds the background path
        {
            id: 1,
            title: "Dune",
        ...
        },
        {
            ...
            heroBg: "resources/hbp_ss.jpg", // High-res poster for hero bg
        ...
        },
        {
            ...
            poster: "resources/avengers_endgame.jpg", // Assuming you'll create this local ima
            heroBg: "resources/avengers_endgame.webp", // High-res poster for hero bg
        ...
        },
        {
            ...
            poster: "resources/LOR_FOR.jpg", // Assuming local image
        ...
        },
        {
            ...
            poster: "resources/the_dark_knight.jpg", // Assuming local image
        ...
        },
        {
            id: 7,
            title: "Forrest Gump",
            poster: "resources/forest_gump.jpg", // Assuming local image
        ...
        },
        {
            id: 8,
            title: "Fight Club",
            poster: "resources/fight_club.jpg", // Assuming local image
        ...
        },
        {
            id: 9,
            title: "Interstellar",
            poster: "resources/interstellar.jpg", // Assuming local image
        ...
        },
        {
            ...
            poster: "resources/hobbit.jpg", // Assuming local image
        ...
        },
        {
            id: 11,
            title: "Joker",
            poster: "resources/joker.jpg", // Assuming local image
        ...
        },
        {
            ...
            poster: "resources/mad_max.jpg", // Assuming local image
        ...
        },
        {
            id: 13,
            title: "The Mummy",
            poster: "resources/the_mummy.jpg", // Assuming local image
    ...
    const $dynamicBg = $('#dynamic-bg'); // Full-page, blurred background
    const $heroBanner = $('#hero-banner'); // Top, sharp hero banner
    ...
    const slideshowImages = movies.slice(0, 15); // Use first 15 movies for slideshow
    ...
    // ===============================================
    // ✅ CORRECTED HOVER LOGIC using Event Delegation
    // This listener is attached to the document once and works for all .movie-card elements,
    // even if they are dynamically added or replaced (like after searching or returning).
    // ===============================================
    ...
    // Updated click on movie card (Detail View) with poster display
